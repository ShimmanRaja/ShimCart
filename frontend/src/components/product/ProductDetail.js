                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            {user ?
                                ...
                                <div className="alt alt-danger mt-5"> Login to Post Review </div>
                            }
                                ...
                                <div className="rating w-50">
                                    <Modal show={show} onHide={handleClose}>
                                        ...
                                        <Modal.Body>
                                            ...
                                            <button disabled={loading} onClick={reviewHandler} aria-label="Close" className="btn my-3px float-right review-btn px-4 text-white"> Submit</button>
                                        </Modal.Body>
                                    </Modal>
                                </div>
                            </div>
